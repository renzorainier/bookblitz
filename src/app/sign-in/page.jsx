...
//   return (
//    <div
//   className="min-h-screen flex flex-col items-center justify-center px-6 py-2"
//   style={{
...
// >
//       {/* Logo Section */}
//       <div className="flex flex-col items-center mt-[-16rem] mb-10">
//   <h1 className="text-white md:text-12xl font-extrabold mt-6 drop-shadow-lg"
//       style={{
//         textShadow: '48px 48px 96px black, -24px -24px 48px black, 24px -24px 48px black, -24px 24px 48px black, 24px 24px 48px black', // Ultra thick shadow for maximum effect
//         backgroundColor: '#6D2B1E', // Rectangular background color
//         padding: '60px 120px', // Large padding for background
//         borderRadius: '8px', // Optional: Rounded corners
//         border: '32px solid black', // Thick black border to match the background
//         fontSize: 'calc(10vw + 30px)', // Responsive font size based on viewport width
...
//         <button
//   onClick={handleGoogleSignIn}
//   className="w-[500px] md:w-[500px] flex items-center justify-center py-10 bg-gradient-to-r from-[#B14E0B] to-[#4B1E1D] text-white border border-gray-300 rounded-lg shadow-xl transform hover:scale-105 transition duration-200 ease-in-out text-sm"
//   style={{
//     boxShadow: "0 0 0 4px rgba(0, 0, 0, 0.8)" // Dark outline effect using box-shadow
//   }}
//   disabled={googleLoading}
// >
